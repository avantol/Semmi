...
namespace WsjtxUdpLib.Messages.Out
{
    ...
    public class DecodeMessage : WsjtxMessage
    {
        ...
        public bool IsNewCountry = false;
        public bool IsNewCountryOnBand = false;
        public bool IsNewCallOnBand = false;
        public bool Modifier = false;
        public bool IsHashedMsg = false;
        ...
        public static new WsjtxMessage Parse(byte[] message)
        {
            ...
            // <K1JT> KG6EMU/AG
            if (decodeMessage.Message.Contains("<")) decodeMessage.IsHashedMsg = true;
            decodeMessage.Message = RemoveAngleBrackets(decodeMessage.Message);         //leave "..." for later detection
